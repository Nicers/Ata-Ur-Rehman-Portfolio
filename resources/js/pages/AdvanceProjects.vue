...
onMounted(async () => {
  try {
    const response = await api.get('projects/advance');
          ...
          <div class="box">
            <div class="title d-flex flex-column align-items-center mb-3">
              <h1 class="px-4 px-lg-5 text-center">
                My Advanced Level Projects
              </h1>
              <img src="../assets/images/line.png" alt="" />
            </div>
            <p class="px-4 px-lg-5">
              Welcome to my advanced level projects page! This section
              highlights my advanced skills in HTML, CSS, JavaScript, Vue.js,
              Laravel, Bootstrap, Tailwind CSS, and PHP. The projects here
              demonstrate my capability to develop dynamic, innovative, and
              scalable web solutions. Explore this section to see how I
              utilize these technologies to create outstanding,
