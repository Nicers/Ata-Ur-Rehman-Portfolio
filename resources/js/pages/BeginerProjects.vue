...
onMounted(async () => {
  try {
    const response = await api.get('projects/beginer');
        ...
        <div class="col-12 w-100 d-md-flex justify-content-md-center">
          <div class="box">
            ...
            <p class="px-4 px-lg-5">
              Welcome to my beginner level projects page! Here, you'll find
              projects that reflect my early steps in web development,
              showcasing foundational skills in HTML, CSS, JavaScript, Vue.js,
              Laravel, Bootstrap, Tailwind CSS, and PHP. These projects
              illustrate my learning journey, dedication, and growth as I
              continue to build a solid foundation in web technologies.
              Explore this section to see my commitment to mastering the
              basics and advancing in the field.
            </p>
          </div>
        </div>
      </div>
