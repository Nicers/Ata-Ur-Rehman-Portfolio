...
<template v-for="section in sections">
          ...
          <div class="box pt-4 w-100 d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="box1 d-md-flex mt-5 py-5 p-3 p-md-5">
              ...
              <div class="about-content d-flex flex-column align-items-center align-items-md-start ps-md-5 w-100">
                <div>
                  <div>
                    <h3 class="text-dark fw-bold">{{ section.data.title }}</h3>
  ...
  <section class="project py-5 bg-black text-white h-auto">
    <div class="container-fluid px-0 px-lg-4 pb-5">
        ...
        <div class="col-12 w-100 d-md-flex justify-content-md-center">
          <div class="box">
            <div class="title d-flex flex-column align-items-center mb-3">
              <h1 class="px-4 px-lg-5 text-center">PROJECTS</h1>
              <img src="../assets/images/line.png" alt="" />
            </div>
            <br />
            <p class="px-4 px-sm-5">
              My portfolio covers a wide range of projects from frontend
              designs to backend APIs, and from classic web solutions to
              cutting edge AI systems.
              <br />
              <b>1. Web Projects:</b><br />
              See dynamic and fully functional web solutions like e-commerce
              platforms and intuitive user interfaces.
              <br />
              <b>2. AI/ML Projects:</b> <br />
              Discover projects demonstrating my proficiency in Python,
              TensorFlow, Keras, and scikit-learn such as Skin Cancer
              Detection, Thyroid Cancer Image Segmentation, Image
              classification and sentiment analysis with Python etc.

              <br /><b>3. WordPress & CMS Solutions:</b><br />
              Explore my expertise in customizing themes and designing
              responsive, user-friendly websites with WordPress.
            </p>
          </div>
        </div>
      </div>
      ...
      <RouterLink :to="`/projects`" class="text-decoration-none">
        <button class="mt-4 py-3 px-5 sameButton" style="display: block; margin: auto">
          See All Projects
        </button>
      </RouterLink>
    </div>
      ...
      <div class="row pt-3">
        <div class="col-12 w-100 d-md-flex justify-content-md-center">
          <div class="box">
            ...
            <p class="px-0 px-sm-5">
              Have a project in mind, or looking to hire a passionate
              versatile software engineer to join your team, feel free to
              reach out.
              <br />
              Let's talk! I am available for remote internships, freelance
              roles, or full-time opportunities.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="col d-flex justify-content-center w-100">
          <div class="form d-flex flex-column align-items-center py-4 mt-3 w-100">
            <div class="c-one d-flex flex-sm-row flex-column justify-content-center gap-3 gap-sm-4 mb-5 mb-sm-4">
              <a href="https://maps.app.goo.gl/WHQdMLXZhGUDw5MW8"
                class="d-flex justify-content-sm-center align-items-center"><i class="fa-solid fa-location-dot"></i>
                &nbsp; Rawalpindi</a>
              <a href="mailto:nicerweb@gmail.com" class="d-flex justify-content-sm-center align-items-center"><i
                  class="fa-solid fa-envelope"></i> &nbsp;
                nicerweb@gmail.com</a>
              <a href="tel:+923404556573" class="d-flex justify-content-sm-center align-items-center"><i
                  class="fa-solid fa-phone"></i> &nbsp; 03404556573</a>
            </div>
            ...
            <form action="https://formspree.io/f/mrgnwngl" method="POST"
              ...
              <input type="submit" class="px-4" value="Send Message" />
            </form>
          </div>
        </div>
      </div>
